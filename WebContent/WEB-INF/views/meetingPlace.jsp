...
<body>
			...
			<div class="row align-items-center justify-content-between">
				<div class="col-sm-6">
					<div class="breadcrumb_tittle">
						<p>주변에 있는 카페, 음식점을 선택해 모임을 생성해보세요.</p>
						<h2>중간 지점 찾기</h2>
					</div>
				</div>
			</div>
	...
	<!-- our_service start-->
	<section class="sample-text-area" id="Body">
		<div class="container box_1170">
			...
			<table>
				<tr style="width: 100%; height:500px;">
					...
					<td>
						<div id="placeInfo" class="blog_details"></div>
					</td>
				</tr>
			</table>
			
			<h3>
				<c:forEach items="${members }" var="user"  varStatus="index">
					${user.id }
